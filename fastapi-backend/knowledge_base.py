"""
Cybercrime Guidance Knowledge Base
Contains PECA 2016 law summaries, crime classifications, evidence checklists,
authority referral info, and AI system prompts for the FastAPI backend.
"""
...
AUTHORITY_REFERRALS = {
    ...
    "childProtection": {
        ...
        "website": "https://soschildrensvillages.pk",
    },
    "peca": {
        "name": "PECA 2016",
...
PECA_SECTIONS = {
    "harassment": {
        ...
        "description": "Whoever intentionally and publicly displays or transmits any information through an information system which he knows to be false and intimidates or harms the reputation or privacy of a person.",
    },
    "blackmailing": {
        "sections": [
        ...
        "penalty": "Imprisonment up to 3 years or fine up to Rs. 1 million, or both",
        "description": "Threatening to share private or fake content to extort money, favors, or compliance falls under offences against dignity and may also involve cyber terrorism provisions.",
    },
    "hacking": {
        "sections": [
        ...
        "description": "Whoever with dishonest intention gains unauthorized access to any information system or copies data without authorization commits an offence under PECA 2016.",
    },
    "financial_fraud": {
        "sections": [
        ...
        "penalty": "Imprisonment up to 3 years or fine up to Rs. 1 million, or both",
        "description": "Online fraud, phishing, and spoofing are criminal offences under PECA 2016. Creating fake websites or emails to deceive people is specifically covered under Section 16.",
    },
    "child_safety": {
        "sections": [
            "Section 21 - Offence against dignity of a person",
        ...
        "description": "PECA 2016 has specific and severe provisions for crimes involving children. Production, distribution, or possession of child pornography carries the harshest penalties under the Act.",
    },
    "other": {
        "sections": ["Section 3-24 - Various provisions of PECA 2016"],
        "penalty": "Varies based on the specific offence",
        "description": "PECA 2016 covers a wide range of cybercrimes. The specific section and penalty depend on the nature of the offence.",
    },
}

SYSTEM_PROMPT = """You are CyberShield AI, an intelligent cybercrime guidance assistant specifically designed for victims of cybercrime in Pakistan. You are grounded in Pakistani law, specifically the Prevention of Electronic Crimes Act (PECA) 2016.
...
CHILD_SAFETY_PROMPT = """You are CyberShield AI's Child Safety Module, specifically designed to help parents and children dealing with online threats and exploitation in Pakistan.
